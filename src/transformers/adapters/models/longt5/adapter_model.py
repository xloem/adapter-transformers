...
from ....models.longt5.modeling_longt5 import LONGT5_INPUTS_DOCSTRING, LONGT5_START_DOCSTRING, LongT5Model, LongT5PreTrainedModel
...
@add_start_docstrings("LongT5 Model with the option to add multiple flexible prediction heads on top.", LONGT5_START_DOCSTRING)
class LongT5AdapterModel(EmbeddingAdaptersWrapperMixin, ModelWithFlexibleHeadsAdaptersMixin, LongT5PreTrainedModel):
    def __init__(self, config):
        super().__init__(config)

        self.transformer = LongT5Model(config)
    ...
    # Copied from LongT5ForConditionalGeneration
...
class LongT5ModelWithHeads(LongT5AdapterModel):
