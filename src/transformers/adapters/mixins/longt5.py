...
class LongT5LocalSelfAttentionLayerAdaptersMixin(AdapterLayer):
    def __init__(self):
        super().__init__("local_adapter", None)


class LongT5TransientGlobalSelfAttentionLayerAdaptersMixin(AdapterLayer):
    def __init__(self):
        super().__init__("tglobal_adapter", None)


class LongT5SelfAttentionLayerAdaptersMixin(AdapterLayer):
    def __init__(self):
        super().__init__("sa_adapter", None)


class LongT5CrossAttentionLayerAdaptersMixin(AdapterLayer):
    def __init__(self):
        super().__init__("cross_adapter", None)


class LongT5FFLayerAdaptersMixin(AdapterLayer):
    def __init__(self):
        super().__init__("output_adapter", None)


class LongT5ModelAdaptersMixin(EmbeddingAdaptersMixin, InvertibleAdaptersMixin, ModelAdaptersMixin):
    """Adds adapters to the LongT5Model class."""
...
class LongT5ModelWithHeadsAdaptersMixin(ModelWithHeadsAdaptersMixin):
    pass
